...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h2>新增產品品項</h2></div>
                    <div class="card-body">
                        <form method="POST" action="{{ asset('admin/product/item/store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="product_price" type="number" class="form-control" name="product_price" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="product_discript">描述</label>
                                <textarea class="form-control" id="product_discript" rows="3" name="product_discript"></textarea>
                            </div>
